...
<div class="fancy">
    ...
    <p>日程内容：<input type="text" class="input" name="event" id="event" style="width:320px" placeholder="write your diary..."></p>
    ...
    <div class="sub_btn"><span class="del"><input type="button" class="btn btn_del" id="del_event" value="Delete"></span><input type="submit" class="btn btn_ok" value="OK"> <input type="button" class="btn btn_cancel" value="Cancel" onClick="$.fancybox.close()"></div>
    </form>
</div>
